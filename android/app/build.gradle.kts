...
// When the file is absent (e.g. a fresh clone or CI without secrets) we fall
// back to debug signing so `flutter run` still works.
...
android {
    ...
    buildTypes {
        release {
            ...
            // Shrink + obfuscate with R8 for a smaller, store-ready bundle.
